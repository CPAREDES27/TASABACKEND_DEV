...
public class ConsultaGeneralTablas {
    ...
    public static String CONSGENCOOZONPES="ZFLZPC";
    public static String CONSGENPESDECLA="ZV_FLCD";
    ...
    public static String CONSGENBALANZA="ZFLBAL";
    ...
    public static String CONSGENCODZONA="ZV_FLPU";
