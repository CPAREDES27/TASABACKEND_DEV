...
public class TrabajoFueraFaenaExports {
    ...
    private List<HashMap<String, Object>> t_mensajes;
    ...
    public List<HashMap<String, Object>> getT_mensajes() {
        return t_mensajes;
    }

    public void setT_mensajes(List<HashMap<String, Object>> t_mensajes) {
        this.t_mensajes = t_mensajes;
    }
