...
public class Constantes {
    ...
    public static String ZFL_RFC_LECT_MAES_EMBAR_BTP ="ZFL_RFC_LECT_MAES_EMBAR_BTP";
    public static String ZFL_RFC_JOB_DESCARGA="ZFL_RFC_JOB_DESCARGA";
    public static String ZFL_RFC_CONS_PREC_PESC_PLTA="ZFL_RFC_CONS_PREC_PESC_PLTA";
    ...
    public static String ZFL_RFC_PESC_COMP_CARGA_HIST="ZFL_RFC_PESC_COMP_CARGA_HIST";
    ...
    public static String ZFL_RFC_DISTR_FLOTA_BTP ="ZFL_RFC_DISTR_FLOTA_BTP";
    ...
    public static String ZFL_RFC_ANULA_MAREA_BTP ="ZFL_RFC_ANULA_MAREA_BTP";
    ...
    public static String ZFL_RFC_VAL_BODEGA_CERT="ZFL_RFC_VAL_BODEGA_CERT";
    ...
    public static String ZFL_RFC_GPES_CONS_CALAS_BTP ="ZFL_RFC_GPES_CONS_CALAS_BTP";
    ...
    public static String ZFL_RFC_LECT_PRECIO_MAR_BTP ="ZFL_RFC_LECT_PRECIO_MAR_BTP";
   ...
   // public static String DESTINATION_NAME_PRD = "TASA_DEST_RFC_PRD";
