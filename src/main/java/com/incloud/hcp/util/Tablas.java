...
public class Tablas {
    ...
    public static String ST_PDG="ST_PDG";
    public static String STR_FASE="STR_FASE";
    public static String STR_DETF="STR_DETF";
    public static String STR_CEF="STR_CEF";
    public static String ZTFL_HISCOM="ZTFL_HISCOM";
    ...
    public static String T_ARCHIVO = "T_ARCHIVOS";
    ...
    public static String ZHR_STR_SEM_TRIP="ZHR_STR_SEM_TRIP";
