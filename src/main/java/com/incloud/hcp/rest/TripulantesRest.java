...
public class TripulantesRest {
    ...
    public ResponseEntity<PDFExports> GenerarPDFProduce(@RequestBody PDFProduceImports imports) {

        try {
            return Optional.ofNullable(this.JCOPDFsService.GenerarPDFProduce(imports))
                    .map(l -> new ResponseEntity<>(l, HttpStatus.OK)).orElse(new ResponseEntity<>(HttpStatus.NOT_FOUND));
        } catch (Exception e) {
            throw new RuntimeException(e.toString());
        }
    ...
    public ResponseEntity<TrabajoDetalleDtoExports> TrabajoFueraFaenaDetalle(@RequestBody TrabajoFueraFaenaDetalleImports imports) {

        try {
            return Optional.ofNullable(this.jcoTrabajoFueraFaenaService.DetalleTrabajoFueraFaenaTransportez(imports))
                    .map(l -> new ResponseEntity<>(l, HttpStatus.OK)).orElse(new ResponseEntity<>(HttpStatus.NOT_FOUND));
        } catch (Exception e) {
            throw new RuntimeException(e.toString());
        }
